...
### Feature Cycle Time
```{r epics, include=TRUE, echo=FALSE, warning=FALSE}
...
epics_cycle_time_plot <- ggplot(epics, aes(x=cldt, y=cylt)) +
    geom_point(aes(colour = factor(Priority))) +
    geom_smooth(method = "loess",
                formula = y ~ x, 
                se = TRUE, 
                colour=finastra_colors["violet"],
                linetype="dashed",
                size=1) +
...
ggplotly(epics_cycle_time_plot)
